...
The next active theorem extends this through the actual local-`q` validity region and smooth zero-extension argument. If that qualifies, the lane continues through the mixed three-component schedule, residual vanishing, and a parallel final-candidate theorem without factor-two growth.
