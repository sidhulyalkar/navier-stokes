...
/-- A stronger certificate genuinely changes the local integer scale exactly
when it makes some integer below the old least scale admissible. -/
...
/-- One explicit stronger-gain admissible integer below the old least scale
forces a strict local change. -/
...
/-- End-to-end strict schedule criterion. -/
