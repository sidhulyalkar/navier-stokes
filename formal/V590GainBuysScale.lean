...
/-- A stronger gain may use a smaller integer cutoff scale if its extra power
pays for the enlarged interval. -/
...
/-- One smaller integer satisfying the power budget forces the least local
scale to decrease. -/
